...
class Scrapper():
    ...
    def __init__(self , username = '' , password = '' , delay = 6) -> None:
        self.delay = delay
                    ...
                    if current_title == 'Your Orders':
                        try:
                            for i in range(15):
                                ...
                                base_element  = self.chrome_driver.find_elements(By.CLASS_NAME , "a-box-group a-spacing-base order js-order-card")
                                
                                
                                for each in base_element:
                                    
                                    print('element scrapped but inner text not working')
                                    first_class_element = self.chrome_driver.find_element(By.CLASS_NAME , "a-color-secondary value")
                                    
                                    second_class_element  = self.chrome_driver.find_element(By.CLASS_NAME , "currencyINRFallback")
